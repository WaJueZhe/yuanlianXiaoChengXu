...
Page({
  ...
  init(val){
    ...
    let task0_criteria = {
      ...
      "searchKey": this.data.searchKey, "isInTransit": "1", "pageNo": this.data.pageNo, "pageSize": this.data.pageSize
    };
    let task1_criteria = {
      "signerTel": this.data.signerTel, "signerTimeBegin": signerTimeBegin, "signerTimeEnd": signerTimeEnd,
      "searchKey": this.data.searchKey, "isSignedOK": "1", "pageNo": this.data.pageNo, "pageSize": this.data.pageSize
    };
    let task2_criteria = {
      "signerTel": this.data.signerTel, "signerTimeBegin": signerTimeBegin, "signerTimeEnd": signerTimeEnd,
      "searchKey": this.data.searchKey, "isSignedOK": "0", "pageNo": this.data.pageNo, "pageSize": this.data.pageSize
    };
