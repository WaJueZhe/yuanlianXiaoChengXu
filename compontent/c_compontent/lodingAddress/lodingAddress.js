// compontent/c_compontent/lodingAddress/lodingAddress.js
  ...
  methods:{
    ...
    init() {
      ...
      let params = {
        ...
        'searchByKeys': { 'searchStr': this.data.searchKey, 'addressType': 'D' },
    ...
    selectLoading(e){
      ...
      prevPage.setData({
        deliverItem: e.currentTarget.dataset.text
      })
